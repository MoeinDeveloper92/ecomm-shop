  ...
  return (
    <Container className="py-10 flex flex-col md:flex-row gap-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-4">
        ...
        {product.stock && (
          <p
            className={`bg-gray-100 w-24 text-center text-green-600 text-sm font-semibold py-2.5 rounded-lg`}
          >
            In Stock
          </p>
        )}
        ...
        <div className="flex items-center gap-2.5 lg:gap-5 w-full">
          ...
          />
          <button className="border   border-darkColor/30 text-darkColor/60 px-2.5 py-1.5  rounded-md hover:text-darkColor hover:border-darkColor">
        ...
        <div className="flex gap-4">
          <div className="flex flex-wrap items-center">
            <div className="border border-drakBlue/20 text-center p-3 hover:border-darkBlue rounded-md hoverEffect">
